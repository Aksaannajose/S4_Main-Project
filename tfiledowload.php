...
<th><strong>Filename</strong></th>
 <th><strong>size (in mb)</strong></th>
...
<tbody>		  
	...
	<?php
	$sql13 = "SELECT * FROM course_table";
   ...
   <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><?php echo floor($file['size'] / 100000) . ' KB'; ?></td>
	...
	<?php
      ...
      <td><a href="uploads/<?php echo $row['Course']; ?>" download="<?php echo $row['Course']; ?>" class="download_link"><?php echo "download"; ?></a></td>
    </tr>
  <?php endforeach;?>
