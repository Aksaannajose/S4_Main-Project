      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
              ...
              <a class="nav-link" href="admincopy">
            ...
            <li class="nav-item">
			  ...
			  <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="placed.php"> user </a></li>
                  <li class="nav-item"> <a class="nav-link" href=""> admin </a></li>
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
    <table class="table table-bordered table-hover table-striped" style="table-layout: fixed">  
      ...
      include( 'connection.php');
        $view_users_query="select * from placed_table";//select query for viewing users.  
...
<!--here showing results in the table -->  
            ...
            <td><a href="view11.php?view=<?php echo $id ?>"><button class="btn btn-danger">Edit</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->  
        </tr>  
