...
<center>
<h2><font color=black>Vacancy List</h2>
<table  border=5  width=90%>
	...
	&nbsp &nbsp &nbsp &nbsp
        ...
        <th>REQ_NO_EMPLOYEES</th>
		<th>SALARIES</th>
		<th>QUALIFICATION_WORKEXPERIENCE</th>
		<th>PREFEREDSEX</th>
		<th>SECTOR_VACANCY</th>
...
<?php
$count=1;
$sel_query="select * from tbljob ";
$result = mysqli_query($conn,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center">&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $count; ?></td>
<td align="center"><?php echo $row["CATEGORY"]; ?></td>
<td align="center"><?php echo $row["OCCUPATIONTITLE"]; ?></td>
<td align="center"><?php echo $row["REQ_NO_EMPLOYEES"]; ?></td>
<td align="center"><?php echo $row["SALARIES"]; ?></td>

<td align="center"><?php echo $row["QUALIFICATION_WORKEXPERIENCE"]; ?></td>
<td align="center"><?php echo $row["PREFEREDSEX"]; ?></td>
<td align="center"><?php echo $row["SECTOR_VACANCY"]; ?></td>
