      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
              ...
              <a class="nav-link" href="pages\samples\admin_update.php">
            ...
            <li class="nav-item">
             <a class="nav-link" href="../admin college.php">
    ...
    <div class="row">
        <div class="col-md-6">
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <a href="admincopy.php" class="btn btn-secondary">Back</a>
...
mysqli_query($conn,"insert into gallery(`image`,`title`,`created`)values('$iname','$t','$d')");
