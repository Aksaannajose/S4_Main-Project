...
$id=$_REQUEST['block'];
$query = "SELECT * from placed_table where id=$id"; 
...
if(isset($_POST['submit'])){
    ...
    mysqli_query($conn,"update placed_table set Name='$name',College='$college',Image='$image' where id=$id") or die(mysqli_error($conn));
