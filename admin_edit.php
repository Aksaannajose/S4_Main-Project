...
$id=$_REQUEST['edit'];
$query = "SELECT * from company_registration_table where id=$id"; 
...
if(isset($_POST['submit'])){
    ...
    $State=$_POST['State'];
    mysqli_query($conn,"update company_registration_table set Company_name_name='$Company_name',Username='$Username',Address='$Address', State='$State' where id=$id") or die(mysqli_error($conn));
...
<p>Company_name : <input type="text" name="Company_name" placeholder="Enter company name" 
required value="<?php echo $row['Company_name'];?>" /></p>
...
<p>State : <input type="text" name="State" placeholder="Enter state" 
