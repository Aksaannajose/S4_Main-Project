            ...
            <div class="form-group">
              <form   action="payment.php" method="get" >
                <div class="form-group has-feedback">
                  <!----- username -------------->
                  <input class="form-control" placeholder="Userid" id="loginid" type="text" autocomplete="off" name="fname"/>
...
<!--                  password-->
  ...
  <img src="course1.jpg" <a href="javascript.php" alt="John" ></a>
  <h1>Java Script</h1>
  <p class="title">Basics to Advanced</p>
