...
?>
  ...
  $result=mysqli_query($conn,"SELECT * FROM `card_activation`") ;
   ?>
   ...
   <div class="company-display">
      <!--<table class="company-display-table" border=5  width=60% >
         ...
         <tr>
		 <td align="center">Register No:<br><br><br>
            <td align="center">First Name <br><br><br>
            <td align="center">Last Name<br><br><br>
            <td align="center">Stream<br><br><br>
            <td align="center">Gender<br><br><br>
			<td align="center">Phone<br><br><br>
  ...
  <label for="u_f_name">First name:</label><br>
  <input type="text" id="u_f_name" name="u_f_name" value="<?php echo $row['u_f_name']; ?>"><br>
  <label for="u_l_name">Last name:</label><br>
  <input type="text" id="u_l_name" name="u_l_name" value="<?php echo $row['u_l_name']; ?>"><br>
  <label for="stream">Stream:</label><br>
  <input type="text" id="stream" name="stream" value="<?php echo $row['stream']; ?>"><br>
  <label for="u_gender">Gender:</label><br>
  <input type="text" id="u_gender" name="u_gender" value="<?php echo $row['u_gender']; ?>"><br>
  <label for="u_phone">Phone Number:</label><br>
  <input type="text" id="u_phone" name="u_phone" value="<?php echo $row['u_phone']; ?>"><br>
  <label for="u_state">State:</label><br>
  <input type="text" id="u_state" name="u_state" value="<?php echo $row['u_state']; ?>"><br>
          ...
          <!--  <tr>
            ...
            <td>-->
             ...
             <!-- <a href="view.php?view=<?php echo $row['id']; ?>" class="btn btn-danger">  View</a>
