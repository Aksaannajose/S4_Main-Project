...
$id=$_REQUEST['edit'];
$query = "SELECT * from college_registration_table where id=$id"; 
...
if(isset($_POST['submit'])){
    ...
    $st=$_POST['st'];
    $uni=$_POST['uni'];
    mysqli_query($conn,"update college_registration_table set College_name='$clgname',District='$dst',State='$st', University='$uni' where id=$id") or die(mysqli_error($conn));
...
<p>College Name : <input type="text" name="clgname" placeholder="Enter college name" 
required value="<?php echo $row['College_name'];?>" /></p>
<p>District : <input type="text" name="dst" placeholder="Enter district name" 
required value="<?php echo $row['District'];?>" /></p>
<p>State : <input type="text" name="st" placeholder="Enter state name" 
required value="<?php echo $row['State'];?>" /></p>
<p>University : <input type="text" name="uni" placeholder="Enter university name" 
