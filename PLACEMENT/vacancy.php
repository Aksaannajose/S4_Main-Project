...
<h2><font color=Black>View Records</h2>
...
<th><strong>company_name</strong></th>
<th><strong>company_description</strong></th>
 <th><strong>vacancy_details</strong></th>
...
<?php
$count=1;
$sel_query="select * from company_table ";
$result = mysqli_query($conn,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center"><?php echo $count; ?></td>
<td align="center"><?php echo $row["company_name"]; ?></td>
<td align="center"><?php echo $row["company_description"]; ?></td>

<td align="center"><?php echo $row["vacancy_details"]; ?></td>
