        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="indexhome.php" class="logo">placement<em> portal</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                    ...
                    <form action="#">
                         ...
                         <div>
                              <label>
                                   ...
                                   <span>Engineer/ Finance / Insurance Jobs (5)</span>
                              </label>
                         </div>
                         ...
                         <div>
                              <label>
                                   ...
                                   <span>Developer/Engineer/ Finance / Insurance Jobs (5)</span>
                              </label>
                         </div>
                         ...
                         <div>
                              <label>
                                   ...
                                   <span>Masters Degree,PhD (5)</span>
                              </label>
                         </div>
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="trainer-item">
                                ...
                                <div class="down-content">
                                    <span> <sup></sup>90 000 </span>

                                    <h4></h4>

                                    <p>Accounting &nbsp;/&nbsp; Health Jobs</p>

                                    <ul class="social-icons">
                                        <li><a href="job-details.php">+ Search</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="trainer-item">
                                <div class="image-thumb">
                                    <img src="assets/images/engg.jpeg" alt="">
                                </div>
                                <div class="down-content">
                                    <span> <sup></sup>90 000 </span>
                        ...
                        <div class="col-md-6">
                            <div class="trainer-item">
                                ...
                                <div class="down-content">
                                    ...
                                    <p>Senior Executive &nbsp;/&nbsp; Health Jobs</p>
